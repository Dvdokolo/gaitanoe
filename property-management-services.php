          ...
          <div class="group relative">
            ...
            <div class="group-hover:block hidden absolute top-full left-0 bg-black/60 backdrop-blur-sm py-6 z-50">
              <div class="w-52 space-y-1">
                ...
                <a href="tenant-information" class="block text-orange-500 bg-[#002f60] px-5 py-2">Tenant Information</a>
              </div>
            </div>
          </div>
    <!-- Sell -->
                  ...
                  <div class="group-hover:block hidden absolute top-full left-0 bg-black/60  backdrop-blur-sm py-6 z-50">
                    <div class="container mx-auto w-[12.5rem] space-y-1">
                      ...
                      <a href="property-management-services"
                        class="block text-orange-500 bg-[#002f60] px-5 py-2 rounded transition-all leading-relaxed">Property management services
                        </a>
                      <a href="free-appraisal-manage"
  ...
  function toggleSubmenu(id) {
    ...
    submenu.classList.toggle("hidden");
        ...
        <div class="relative w-full h-[500px] overflow-hidden">
          <!-- Background image -->
          <img src="images/key.webp" alt="Background" class="w-full h-full object-cover">
...
<div class="lg:flex  justify-evenly">
  ...
  <img src="images/1 (1).webp" class="mx-auto" alt="">
  <br>
  <p class="md:w-[40rem] lg:mx-0 mx-auto px-[1rem]">
   <span class="font-bold">Online Applications</span>
   <br>
   <br>
...
<div class="lg:flex justify-evenly">
 <p class="md:w-[40rem] lg:mx-0 mx-auto px-[1rem]">
   <span class="font-bold">Reference Checking</span>
   <br>
    <br>
...
<div class="lg:flex  justify-evenly">
  ...
  <img src="images/3 (1).webp" class="mx-auto" alt="">
  <br>
   <p class="md:w-[40rem] lg:mx-0 mx-auto px-[1rem]">
   <span class="font-bold"> Collecting Rent</span>
   <br>
   <br>
Tenant direct debit
<br>
...
<div class="lg:flex  justify-evenly">
  ...
  <img src="images/4.webp" class="mx-auto" alt="">
  <br>
  <p class="md:w-[40rem] lg:mx-0 mx-auto px-[1rem]">
   <span class="font-bold">Payment of Outgoings</span>
   <br>
   <br>
No extra charge
<br>
Ease of EOFY accounting
<br>
Part of Morton service
...
<!-- search -->
        ...
        <div class="relative w-full h-[700px] mt-[10rem] overflow-hidden">
          <!-- Background image -->
