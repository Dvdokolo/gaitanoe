          ...
          <div class="group relative">
            ...
            <div class="group-hover:block hidden absolute top-full left-0 bg-black/60 backdrop-blur-sm py-6 z-50">
              <div class="w-52 space-y-1">
                ...
                <a href="this-week’s-opens" class="block text-orange-500 bg-[#002f60] px-5 py-2">This week’s opens</a>
                <a href="this-week’s-options"class="block text-gray-300 hover:text-orange-500 hover:bg-[#002f60] px-5 py-2">This week’s options</a>
...
<div class="property-schedule  ">
  ...
  <div class="property-item justify-between">
    <img src="https://source.unsplash.com/120x90/?real-estate,home" alt="Property in Wuse Zone 6" />
    <div>
      <strong>Wuse Zone 6</strong><br />
      Plot 21 Obasanjo Way
    </div>
    <div>
      📅 Wed 16th Jul<br />
      🕒 12:15 PM - 12:45 PM
    ...
    <div>Just Listed</div>
    <div>
      <strong>Fatima Bello</strong><br />
      0903 456 7890
    </div>
  </div>

  <div class="property-item justify-between">
    <img src="https://source.unsplash.com/120x90/?apartment,dining" alt="Property in Jabi" />
    <div>
      <strong>Jabi</strong><br />
      18 Alex Ekwueme Way
    </div>
    <div>
      📅 Wed 16th Jul<br />
    ...
    <div>₦95,000,000 - ₦105,000,000</div>
    <div>
      <strong>Uche Nwosu</strong><br />
      0810 234 5678
    </div>
  </div>
</div>
