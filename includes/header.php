...
<header class="relative">
      ...
      <div class="flex justify-between items-center">
        ...
        <div class="hidden lg:flex items-center space-x-2" style="margin-bottom: -10px;">
          ...
          <div class="group relative">
            ...
            <div class="group-hover:block hidden absolute top-full left-0 bg-black/60 backdrop-blur-sm py-6 z-50">
              <div class="w-52 space-y-1">
                <a href="properties-for-sale"class="block text-orange-500 bg-[#002f60] px-5 py-2 leading-relaxed">Properties for sale</a>
                ...
                <a href="recent-sales" class="block text-gray-300 hover:text-orange-500 hover:bg-[#002f60] px-5 py-2 leading-relaxed">Recent Sales</a>
              </div>
            </div>
          </div>
          ...
          <div class="group relative">
            ...
            <div class="group-hover:block hidden absolute top-full left-0 bg-black/60 backdrop-blur-sm py-6 z-50">
              <div class="w-52 space-y-1">
                <a href="properties-for-rent" class="block text-gray-300 hover:text-orange-500 hover:bg-[#002f60] leading-relaxed px-5 py-2">Rental Properties</a>
                <a href="recent-leases"class="block text-gray-300 hover:text-orange-500 hover:bg-[#002f60] leading-relaxed px-5 py-2">Recent leases</a>
                <a href="property-alert"  class="block text-gray-300 hover:text-orange-500 hover:bg-[#002f60] leading-relaxed px-5 py-2">Property Alert</a>
                <a href="tenant-information" class="block text-gray-300 hover:text-orange-500 hover:bg-[#002f60] leading-relaxed px-5 py-2">Tenant Information</a>
              </div>
            </div>
          </div>
    <!-- Sell -->
        ...
        <div class="hidden lg:block group relative">
                  <button class="px-4 py-8 hover-bg-brand hover-text-brand transition-all">Account Access</button>
                  <div class="group-hover:block hidden absolute top-full left-0 bg-black/60  backdrop-blur-sm py-6 z-50">
                    <div class="container mx-auto w-[12.5rem] space-y-1">
                      <a href="staff-portal"
  ...
  <div id="mobile-menu" class="hidden lg:hidden bg-black/90 absolute w-full z-40 mt-24 text-white text-base">
    <div class="px-4 pt-2 pb-4 space-y-3">
      ...
      <div>
        <button onclick="toggleSubmenu('login-submenu')" class="w-full text-left py-2 px-4 hover:bg-[#002f60]">Account Access</button>
